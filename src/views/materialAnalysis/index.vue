  ...
  <div class="container">
    ...
    <div class="common-table">
      ...
      >
        ...
        <el-table-column prop="entrust" label="委托单" width="110" align="center">
          <template #default="scope">
            <div style="height: 100%; display: flex; align-items: center; justify-content: center">
              <el-icon size="18" :color="scope.row.entrust ? '#67c23a' : '#F56C6C'">
        ...
        <el-table-column prop="demand" label="需求规格说明书" width="110" align="center">
          <template #default="scope">
            <div style="height: 100%; display: flex; align-items: center; justify-content: center">
              <el-icon size="18" :color="scope.row.demand ? '#67c23a' : '#F56C6C'">
        ...
        <el-table-column prop="asset" label="资产收集表" width="110" align="center">
          <template #default="scope">
            <div style="height: 100%; display: flex; align-items: center; justify-content: center">
              <el-icon size="18" :color="scope.row.asset ? '#67c23a' : '#F56C6C'">
        ...
        <el-table-column prop="case" label="功能测试用例" width="110" align="center">
          <template #default="scope">
            <div style="height: 100%; display: flex; align-items: center; justify-content: center">
              <el-icon size="18" :color="scope.row.case ? '#67c23a' : '#F56C6C'">
        ...
        <el-table-column prop="perf" label="性能测试清单" width="110" align="center">
          <template #default="scope">
            <div style="height: 100%; display: flex; align-items: center; justify-content: center">
              <el-icon size="18" :color="scope.row.perf ? '#67c23a' : '#F56C6C'">
        ...
        <el-table-column prop="cybersecurity" label="网络安全设计方案" width="120" align="center">
          <template #default="scope">
            <div style="height: 100%; display: flex; align-items: center; justify-content: center">
              <el-icon size="18" :color="scope.row.cybersecurity ? '#67c23a' : '#F56C6C'">
        ...
        <el-table-column prop="status" label="状态" width="100" align="center">
          <template #default="scope">
            <el-tag size="small" :type="STATUS_OPTIONS[+(scope.row.status - 1)].type">{{
              STATUS_OPTIONS[+(scope.row.status - 1)].label
            }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column fixed="right" label="操作" width="220" align="center">
          <template v-slot="scope">
            ...
            <el-button
              ...
              type="success"
              size="small"
              :disabled="!scope.row.demand_docx"
            >
              生成用例
            </el-button>
      ...
      >
        ...
        >
          ...
          <el-form-item required prop="scene_order" class="flex-center">
            <template #label>
              ...
              <el-tooltip content="💡长按拖动选项，可调整场景顺序" placement="top">
                <el-icon class="tip-icon"><Warning /></el-icon> </el-tooltip
              >:
            </template>
          ...
          <el-form-item label="知识库：" required prop="knowledgeId" v-if="addForm.is_knowledge">
            <el-select v-model="addForm.knowledgeId" multiple placeholder="请选择知识库">
              <el-option
...
const formRules = reactive({
  ...
  positive_ratio: [
    { required: true, message: '正常场景用例占比率为必填', trigger: ['blur', 'change'] },
  ],
  negative_ratio: [
    { required: true, message: '异常场景用例占比率为必填', trigger: ['blur', 'change'] },
  ],
  boundary_ratio: [
    { required: true, message: '边界值用例占比率为必填', trigger: ['blur', 'change'] },
  ],
