      ...
      >
        ...
        <el-table-column prop="status" label="状态" width="100" align="center">
          <template #default="scope">
            <el-tag size="small" :type="statusType[+(scope.row.status - 1)]">{{
        ...
        >
          <template #default="scope">
            {{ scope.row.failedReason ? scope.row.failedReason : '--' }}
          </template>
        </el-table-column>
        <!-- <el-table-column
					prop="size"
        ...
        <el-table-column fixed="right" label="操作" width="220" align="center">
          <template v-slot="scope">
            ...
            <el-button @click="handleDownLoad(scope.row)" type="success" size="small">
              下载
            </el-button>
        ...
        >
          ...
          <el-form-item label="需求规格说明书：" required prop="requirementFile">
            <div style="display: flex; align-items: center">
              <el-button type="primary" :loading="isUploading" @click="docxFile.click()">
                {{ isUploading ? '上传中...' : '点击上传文件' }}
                <el-icon v-if="!isUploading" style="margin-left: 4px; font-size: 18px">
                  <UploadFilled />
                </el-icon>
              </el-button>
